  ...
  return (
    <section className="relative py-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-96 h-96 bg-pink-500/5 rounded-full blur-3xl" />
      </div>
        ...
        >
          {stats.map((stat, index) => (
            ...
            >
              ...
              {/* Card */}
              <div className="rounded-2xl border-2 border-lime-400/30 bg-gradient-to-br from-gray-900/50 to-gray-900/20 backdrop-blur-sm p-8 md:p-10 text-center group-hover:border-lime-400/60 transition-all duration-300">
                {/* Value with glow */}
                <motion.div
                  className="mb-4"
                  initial={{ scale: 0 }}
                  ...
                  viewport={{ once: true }}
                >
                  <p className="text-5xl md:text-6xl lg:text-7xl font-display font-black text-lime-400 text-glow">
