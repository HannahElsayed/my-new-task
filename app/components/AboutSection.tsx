      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
        <div className="flex flex-col items-center justify-center text-center gap-10">
          ...
          <motion.p
            ...
            className="text-gray-300 max-w-2xl leading-relaxed text-base md:text-lg"
          >
          ...
          >
            ...
            <div className="w-full flex flex-wrap items-center  gap-4 md:gap-4">
              {['HTML', 'CSS', 'JavaScript', 'React', 'Next.js', 'Tailwind CSS', 'Figma', 'Adobe XD', 'UI/UX', 'Java', 'JavaFX', 'SQL', 'Oracle', 'Data Structures', 'OOP'].map((skill) => (
                <span
                  key={skill}
                  className="text-sm md:text-base font-medium text-gray-100 bg-gradient-to-br from-purple-500/20 to-pink-500/10 px-4 py-2 rounded-2xl border border-purple-500/30 hover:border-purple-500/70 hover:bg-purple-500/25 hover:shadow-lg hover:shadow-purple-500/30 transition-all duration-300 whitespace-nowrap"
                >
                  {skill}
                </span>
              ))}
